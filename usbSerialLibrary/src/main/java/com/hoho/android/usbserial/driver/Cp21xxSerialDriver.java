...
//        private static final int MCR_RTS = 0x0002;
        ...
        @Override
        protected boolean initPortSepcific(UsbManager usbManager) throws IOException, AccessControlException {
        ...
        @Override
        protected boolean initOnlyPortSepcific(UsbDeviceConnection connection) throws IOException, AccessControlException {
            return true;
        }
