...
public enum UsbSerialProber {
    ...
    // added to support EasyIO from CCS .... JZ 29/07/2014
    CCS_SERIAL {
        @Override
        public UsbSerialDriver getDevice(final UsbDevice usbDevice) {
            if (testIfSupported(usbDevice)) {
                return new CCSSerialDriver(usbDevice);
            } else {
                return null;
            }
        }
        ...
        @Override
        public boolean testIfSupported(final UsbDevice usbDevice) {
            return testIfInSupportedDevicesMap(usbDevice,  CCSSerialDriver.getSupportedDevices());
        }
    },   
