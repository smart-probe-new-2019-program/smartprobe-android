...
public interface UsbSerialPort {
     ...
     */
    public boolean open(UsbManager usbManager) throws IOException, AccessControlException;
    /**
     ...
     */
    public boolean open(UsbDeviceConnection connection) throws IOException;
    /**
